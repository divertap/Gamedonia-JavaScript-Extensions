...
JSBool JSB_GamedoniaInAppPurchases_delegate(JSContext *cx, uint32_t argc, jsval *vp);


extern JSObject *JSB_GamedoniaInAppPurchases_object;
extern JSClass *JSB_GamedoniaInAppPurchases_class;
...
/* Proxy class */
@interface JSB_GamedoniaInAppPurchases : JSB_NSObject
{
}
@end
...
extern JSObject *JSB_GamedoniaDevice_object;
extern JSClass *JSB_GamedoniaDevice_class;
...
/* Proxy class */
@interface JSB_GamedoniaDevice : JSB_NSObject
{
}
@end
...
extern JSObject *JSB_GDPaymentTransaction_object;
extern JSClass *JSB_GDPaymentTransaction_class;
...
/* Proxy class */
@interface JSB_GDPaymentTransaction : JSB_NSObject
{
}
@end
...
extern JSObject *JSB_GamedoniaScript_object;
extern JSClass *JSB_GamedoniaScript_class;
...
/* Proxy class */
@interface JSB_GamedoniaScript : JSB_NSObject
{
}
@end
...
extern JSObject *JSB_GamedoniaPush_object;
extern JSClass *JSB_GamedoniaPush_class;
...
/* Proxy class */
@interface JSB_GamedoniaPush : JSB_NSObject
{
}
@end
...
extern JSObject *JSB_GDPurchaseDelegateAdapter_object;
extern JSClass *JSB_GDPurchaseDelegateAdapter_class;
...
/* Proxy class */
@interface JSB_GDPurchaseDelegateAdapter : JSB_NSObject
{
}
@end

/* Manually generated callbacks */
@interface JSB_GDPurchaseDelegateAdapter (Manual)
...
extern JSObject *JSB_GDDeviceProfile_object;
extern JSClass *JSB_GDDeviceProfile_class;
...
/* Proxy class */
@interface JSB_GDDeviceProfile : JSB_NSObject
{
}
@end

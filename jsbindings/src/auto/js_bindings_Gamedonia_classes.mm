...
void JSB_GDUserProfile_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("profile", JSB_GDUserProfile_profile, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
...
void JSB_GamedoniaRequest_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	JSB_GamedoniaRequest_class->flags = JSCLASS_HAS_RESERVED_SLOTS(3);
...
void JSB_Credentials_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("setFbUID", JSB_Credentials_setFb_uid_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setGamecenterID", JSB_Credentials_setGamecenter_id_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		...
		JS_FN("setTwID", JSB_Credentials_setTw_uid_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),

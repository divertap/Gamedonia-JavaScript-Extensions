...
* Generated by "generate_js_bindings.py -c Gamedonia.jsb.ini" on 2013-10-11
* Script version: v0.3
*/
 ...
 */
#pragma mark - GamedoniaInAppPurchases

JSClass* JSB_GamedoniaInAppPurchases_class = NULL;
JSObject* JSB_GamedoniaInAppPurchases_object = NULL;
// Constructor
JSBool JSB_GamedoniaInAppPurchases_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	JSObject *jsobj = [JSB_GamedoniaInAppPurchases createJSObjectWithRealObject:nil context:cx];
	JS_SET_RVAL(cx, vp, OBJECT_TO_JSVAL(jsobj));
	return JS_TRUE;
}

// Destructor
void JSB_GamedoniaInAppPurchases_finalize(JSFreeOp *fop, JSObject *obj)
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (GamedoniaInAppPurchases)", obj);
//	JSB_NSObject *proxy = (JSB_NSObject*) jsb_get_proxy_for_jsobject(obj);
//	if (proxy) {
//		[[proxy realObj] release];
//	}
...
// Arguments: NSString*
// Ret value: void (None)
JSBool JSB_GamedoniaInAppPurchases_buyProductIdentifier_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	GamedoniaInAppPurchases *real = (GamedoniaInAppPurchases*) [proxy realObj];
	[real buyProductIdentifier:(NSString*)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: 
// Ret value: BOOL (b)
JSBool JSB_GamedoniaInAppPurchases_canMakePayments(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: NSSet* (set)
JSBool JSB_GamedoniaInAppPurchases_productIdentifiers(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	GamedoniaInAppPurchases *real = (GamedoniaInAppPurchases*) [proxy realObj];
	ret_val = [real productIdentifiers ];
...
JSBool JSB_GamedoniaInAppPurchases_products(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSSet*
// Ret value: void (None)
JSBool JSB_GamedoniaInAppPurchases_requestProducts_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	GamedoniaInAppPurchases *real = (GamedoniaInAppPurchases*) [proxy realObj];
	[real requestProducts:(NSSet*)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: NSObject*
// Ret value: void (None)
JSBool JSB_GamedoniaInAppPurchases_setDelegate_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSSet*
// Ret value: void (None)
JSBool JSB_GamedoniaInAppPurchases_setProductIdentifiers_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	GamedoniaInAppPurchases *real = (GamedoniaInAppPurchases*) [proxy realObj];
	[real setProductIdentifiers:(NSSet*)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: NSArray*
// Ret value: void (None)
JSBool JSB_GamedoniaInAppPurchases_setProducts_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	GamedoniaInAppPurchases *real = (GamedoniaInAppPurchases*) [proxy realObj];
	[real setProducts:(NSArray*)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}

void JSB_GamedoniaInAppPurchases_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	JSB_GamedoniaInAppPurchases_class = (JSClass *)calloc(1, sizeof(JSClass));
	JSB_GamedoniaInAppPurchases_class->name = name;
	JSB_GamedoniaInAppPurchases_class->addProperty = JS_PropertyStub;
	JSB_GamedoniaInAppPurchases_class->delProperty = JS_PropertyStub;
	JSB_GamedoniaInAppPurchases_class->getProperty = JS_PropertyStub;
	JSB_GamedoniaInAppPurchases_class->setProperty = JS_StrictPropertyStub;
	JSB_GamedoniaInAppPurchases_class->enumerate = JS_EnumerateStub;
	JSB_GamedoniaInAppPurchases_class->resolve = JS_ResolveStub;
	JSB_GamedoniaInAppPurchases_class->convert = JS_ConvertStub;
	JSB_GamedoniaInAppPurchases_class->finalize = JSB_GamedoniaInAppPurchases_finalize;
	JSB_GamedoniaInAppPurchases_class->flags = 0;

	static JSPropertySpec properties[] = {
		{0, 0, 0, 0, 0}
	};
	static JSFunctionSpec funcs[] = {
		JS_FN("buyProductIdentifier", JSB_GamedoniaInAppPurchases_buyProductIdentifier_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("canMakePayments", JSB_GamedoniaInAppPurchases_canMakePayments, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getDelegate", JSB_GamedoniaInAppPurchases_delegate, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getProductIdentifiers", JSB_GamedoniaInAppPurchases_productIdentifiers, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getProducts", JSB_GamedoniaInAppPurchases_products, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("requestProducts", JSB_GamedoniaInAppPurchases_requestProducts_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setDelegate", JSB_GamedoniaInAppPurchases_setDelegate_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setProductIdentifiers", JSB_GamedoniaInAppPurchases_setProductIdentifiers_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setProducts", JSB_GamedoniaInAppPurchases_setProducts_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FS_END
	};
	static JSFunctionSpec st_funcs[] = {
		JS_FS_END
	...
	JSB_GamedoniaInAppPurchases_object = JS_InitClass(cx, globalObj, JSB_NSObject_object, JSB_GamedoniaInAppPurchases_class, JSB_GamedoniaInAppPurchases_constructor,0,properties,funcs,NULL,st_funcs);
	JSBool found;
	JS_SetPropertyAttributes(cx, globalObj, name, JSPROP_ENUMERATE | JSPROP_READONLY, &found);
}

@implementation JSB_GamedoniaInAppPurchases

+(JSObject*) createJSObjectWithRealObject:(id)realObj context:(JSContext*)cx
{
	JSObject *jsobj = JS_NewObject(cx, JSB_GamedoniaInAppPurchases_class, JSB_GamedoniaInAppPurchases_object, NULL);
	JSB_GamedoniaInAppPurchases *proxy = [[JSB_GamedoniaInAppPurchases alloc] initWithJSObject:jsobj class:[GamedoniaInAppPurchases class]];
	[proxy setRealObj:realObj];
...
// Arguments: NSObject*
// Ret value: void (None)
JSBool JSB_GDUser_fromJSON_(JSContext *cx, uint32_t argc, jsval *vp) {
...
void JSB_GDUser_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("fromJSON", JSB_GDUser_fromJSON_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
...
// Arguments: 
// Ret value: GamedoniaInAppPurchases* (o)
JSBool JSB_Gamedonia_newPurchase_static(JSContext *cx, uint32_t argc, jsval *vp) {
	JSB_PRECONDITION3( argc == 0, cx, JS_FALSE, "Invalid number of arguments" );
	GamedoniaInAppPurchases* ret_val;

	ret_val = [Gamedonia newPurchase ];
...
// Arguments: 
// Ret value: GamedoniaInAppPurchases* (o)
JSBool JSB_Gamedonia_purchase_static(JSContext *cx, uint32_t argc, jsval *vp) {
	JSB_PRECONDITION3( argc == 0, cx, JS_FALSE, "Invalid number of arguments" );
	GamedoniaInAppPurchases* ret_val;

	ret_val = [Gamedonia purchase ];
...
void JSB_Gamedonia_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec st_funcs[] = {
		...
		JS_FN("getNewPurchase", JSB_Gamedonia_newPurchase_static, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		...
		JS_FN("getPurchase", JSB_Gamedonia_purchase_static, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
 ...
 */
#pragma mark - GDPaymentTransaction

JSClass* JSB_GDPaymentTransaction_class = NULL;
JSObject* JSB_GDPaymentTransaction_object = NULL;
// Constructor
JSBool JSB_GDPaymentTransaction_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	JSObject *jsobj = [JSB_GDPaymentTransaction createJSObjectWithRealObject:nil context:cx];
	JS_SET_RVAL(cx, vp, OBJECT_TO_JSVAL(jsobj));
	return JS_TRUE;
}

// Destructor
void JSB_GDPaymentTransaction_finalize(JSFreeOp *fop, JSObject *obj)
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (GDPaymentTransaction)", obj);
//	JSB_NSObject *proxy = (JSB_NSObject*) jsb_get_proxy_for_jsobject(obj);
//	if (proxy) {
//		[[proxy realObj] release];
//	}
...
// Arguments: 
// Ret value: NSString* (S)
JSBool JSB_GDPaymentTransaction_identifier(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	GDPaymentTransaction *real = (GDPaymentTransaction*) [proxy realObj];
	ret_val = [real identifier ];
...
// Arguments: 
// Ret value: NSString* (S)
JSBool JSB_GDPaymentTransaction_receipt(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSString*
// Ret value: void (None)
JSBool JSB_GDPaymentTransaction_setIdentifier_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	GDPaymentTransaction *real = (GDPaymentTransaction*) [proxy realObj];
	[real setIdentifier:(NSString*)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: NSString*
// Ret value: void (None)
JSBool JSB_GDPaymentTransaction_setReceipt_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSString*
// Ret value: void (None)
JSBool JSB_GDPaymentTransaction_setStatus_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: BOOL
// Ret value: void (None)
JSBool JSB_GDPaymentTransaction_setSuccess_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSString*
// Ret value: void (None)
JSBool JSB_GDPaymentTransaction_setTransactionId_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	GDPaymentTransaction *real = (GDPaymentTransaction*) [proxy realObj];
	[real setTransactionId:(NSString*)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: 
// Ret value: NSString* (S)
JSBool JSB_GDPaymentTransaction_status(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: BOOL (b)
JSBool JSB_GDPaymentTransaction_success(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: NSString* (S)
JSBool JSB_GDPaymentTransaction_transactionId(JSContext *cx, uint32_t argc, jsval *vp) {
...
void JSB_GDPaymentTransaction_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	JSB_GDPaymentTransaction_class = (JSClass *)calloc(1, sizeof(JSClass));
	JSB_GDPaymentTransaction_class->name = name;
	JSB_GDPaymentTransaction_class->addProperty = JS_PropertyStub;
	JSB_GDPaymentTransaction_class->delProperty = JS_PropertyStub;
	JSB_GDPaymentTransaction_class->getProperty = JS_PropertyStub;
	JSB_GDPaymentTransaction_class->setProperty = JS_StrictPropertyStub;
	JSB_GDPaymentTransaction_class->enumerate = JS_EnumerateStub;
	JSB_GDPaymentTransaction_class->resolve = JS_ResolveStub;
	JSB_GDPaymentTransaction_class->convert = JS_ConvertStub;
	JSB_GDPaymentTransaction_class->finalize = JSB_GDPaymentTransaction_finalize;
	JSB_GDPaymentTransaction_class->flags = 0;

	static JSPropertySpec properties[] = {
		{0, 0, 0, 0, 0}
	};
	static JSFunctionSpec funcs[] = {
		JS_FN("getIdentifier", JSB_GDPaymentTransaction_identifier, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getReceipt", JSB_GDPaymentTransaction_receipt, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setIdentifier", JSB_GDPaymentTransaction_setIdentifier_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setReceipt", JSB_GDPaymentTransaction_setReceipt_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setStatus", JSB_GDPaymentTransaction_setStatus_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setSuccess", JSB_GDPaymentTransaction_setSuccess_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setTransactionId", JSB_GDPaymentTransaction_setTransactionId_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getStatus", JSB_GDPaymentTransaction_status, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getSuccess", JSB_GDPaymentTransaction_success, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getTransactionId", JSB_GDPaymentTransaction_transactionId, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FS_END
	};
	static JSFunctionSpec st_funcs[] = {
		JS_FS_END
	...
	JSB_GDPaymentTransaction_object = JS_InitClass(cx, globalObj, JSB_NSObject_object, JSB_GDPaymentTransaction_class, JSB_GDPaymentTransaction_constructor,0,properties,funcs,NULL,st_funcs);
	JSBool found;
	JS_SetPropertyAttributes(cx, globalObj, name, JSPROP_ENUMERATE | JSPROP_READONLY, &found);
}

@implementation JSB_GDPaymentTransaction

+(JSObject*) createJSObjectWithRealObject:(id)realObj context:(JSContext*)cx
{
	JSObject *jsobj = JS_NewObject(cx, JSB_GDPaymentTransaction_class, JSB_GDPaymentTransaction_object, NULL);
	JSB_GDPaymentTransaction *proxy = [[JSB_GDPaymentTransaction alloc] initWithJSObject:jsobj class:[GDPaymentTransaction class]];
	[proxy setRealObj:realObj];
 ...
 */
#pragma mark - GDPurchaseDelegateAdapter

JSClass* JSB_GDPurchaseDelegateAdapter_class = NULL;
JSObject* JSB_GDPurchaseDelegateAdapter_object = NULL;
// Constructor
JSBool JSB_GDPurchaseDelegateAdapter_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	JSObject *jsobj = [JSB_GDPurchaseDelegateAdapter createJSObjectWithRealObject:nil context:cx];
	JS_SET_RVAL(cx, vp, OBJECT_TO_JSVAL(jsobj));
	return JS_TRUE;
}

// Destructor
void JSB_GDPurchaseDelegateAdapter_finalize(JSFreeOp *fop, JSObject *obj)
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (GDPurchaseDelegateAdapter)", obj);
//	JSB_NSObject *proxy = (JSB_NSObject*) jsb_get_proxy_for_jsobject(obj);
//	if (proxy) {
//		[[proxy realObj] release];
//	}
...
// Arguments: 
// Ret value: None (None)
JSBool JSB_GDPurchaseDelegateAdapter_init(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	GDPurchaseDelegateAdapter *real = [(GDPurchaseDelegateAdapter*)[proxy.klass alloc] init ];
	[proxy setRealObj: real];
	[real autorelease];
...
void JSB_GDPurchaseDelegateAdapter_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	JSB_GDPurchaseDelegateAdapter_class = (JSClass *)calloc(1, sizeof(JSClass));
	JSB_GDPurchaseDelegateAdapter_class->name = name;
	JSB_GDPurchaseDelegateAdapter_class->addProperty = JS_PropertyStub;
	JSB_GDPurchaseDelegateAdapter_class->delProperty = JS_PropertyStub;
	JSB_GDPurchaseDelegateAdapter_class->getProperty = JS_PropertyStub;
	JSB_GDPurchaseDelegateAdapter_class->setProperty = JS_StrictPropertyStub;
	JSB_GDPurchaseDelegateAdapter_class->enumerate = JS_EnumerateStub;
	JSB_GDPurchaseDelegateAdapter_class->resolve = JS_ResolveStub;
	JSB_GDPurchaseDelegateAdapter_class->convert = JS_ConvertStub;
	JSB_GDPurchaseDelegateAdapter_class->finalize = JSB_GDPurchaseDelegateAdapter_finalize;
	JSB_GDPurchaseDelegateAdapter_class->flags = 0;

	static JSPropertySpec properties[] = {
		{0, 0, 0, 0, 0}
	};
	static JSFunctionSpec funcs[] = {
		JS_FN("init", JSB_GDPurchaseDelegateAdapter_init, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("productsRequested", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("productPurchased", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FS_END
	};
	static JSFunctionSpec st_funcs[] = {
		JS_FS_END
	...
	JSB_GDPurchaseDelegateAdapter_object = JS_InitClass(cx, globalObj, JSB_NSObject_object, JSB_GDPurchaseDelegateAdapter_class, JSB_GDPurchaseDelegateAdapter_constructor,0,properties,funcs,NULL,st_funcs);
	JSBool found;
	JS_SetPropertyAttributes(cx, globalObj, name, JSPROP_ENUMERATE | JSPROP_READONLY, &found);
}

@implementation JSB_GDPurchaseDelegateAdapter

+(JSObject*) createJSObjectWithRealObject:(id)realObj context:(JSContext*)cx
{
	JSObject *jsobj = JS_NewObject(cx, JSB_GDPurchaseDelegateAdapter_class, JSB_GDPurchaseDelegateAdapter_object, NULL);
	JSB_GDPurchaseDelegateAdapter *proxy = [[JSB_GDPurchaseDelegateAdapter alloc] initWithJSObject:jsobj class:[GDPurchaseDelegateAdapter class]];
	[proxy setRealObj:realObj];
...
+(void) swizzleMethods
{
	...
	static BOOL GDPurchaseDelegateAdapter_already_swizzled = NO;
	if( ! GDPurchaseDelegateAdapter_already_swizzled ) {
		NSError *error;

		if( ! [GDPurchaseDelegateAdapter jr_swizzleMethod:@selector(productsRequested:) withMethod:@selector(JSHook_productsRequested:) error:&error] )
			NSLog(@"Error swizzling %@", error);

		if( ! [GDPurchaseDelegateAdapter jr_swizzleMethod:@selector(productPurchased:) withMethod:@selector(JSHook_productPurchased:) error:&error] )
			NSLog(@"Error swizzling %@", error);

		GDPurchaseDelegateAdapter_already_swizzled = YES;
	}
}

@end
@implementation GDPurchaseDelegateAdapter (JSBindings)

-(void) JSHook_productsRequested:(NSArray*)productsList 
{
	//1st call native, then JS. Order is important
	[self JSHook_productsRequested:productsList ];
	JSB_GDPurchaseDelegateAdapter *proxy = objc_getAssociatedObject(self, &JSB_association_proxy_key);
	if( proxy )
		[proxy productsRequested:productsList ];

}

-(void) JSHook_productPurchased:(GDPaymentTransaction*)transaction 
{
	//1st call native, then JS. Order is important
	[self JSHook_productPurchased:transaction ];
	JSB_GDPurchaseDelegateAdapter *proxy = objc_getAssociatedObject(self, &JSB_association_proxy_key);
	if( proxy )
		[proxy productPurchased:transaction ];
...
// Arguments: NSObject*
// Ret value: void (None)
JSBool JSB_Credentials_fromJSON_(JSContext *cx, uint32_t argc, jsval *vp) {
...
void JSB_Credentials_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("fromJSON", JSB_Credentials_fromJSON_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
